...
<div id="kt_header" class="header header-fixed">
    <!--begin::Container-->
    <div class="container-fluid d-flex align-items-stretch justify-content-between" style="margin-left: 20px">
...
{{--                        <a href="{{url()->previous()}}" class="menu-link">--}}
                        <a href="javascript:window.location.reload(true)" class="menu-link">
        ...
        <div class="topbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <form>
                        <!--begin::Header-->
                        <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url('https://img.freepik.com/free-photo/holi-color-background-white-background_24972-874.jpg')">
                            <!--begin::Title-->
...
{{--                        </li>--}}
            ...
            <div class="topbar-item">
                <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                    ...
                    <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">Employee</span>
