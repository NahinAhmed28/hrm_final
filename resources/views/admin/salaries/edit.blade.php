                    ...
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            <div class="example-tools justify-content-center">
                                <a href="{{route('admin.salaries.index')}}" class="btn btn-primary mr-3"><i class="flaticon-list-2"></i>Departments</a>
                            </div>
                        </div>
                    </div>
                    <!--begin::Form-->
                    <form action="{{ route('admin.salaries.update', $salaries->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="row">
