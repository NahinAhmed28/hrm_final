        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-custom">
                    ...
                    <!--begin::Form-->
                    <form action="{{ route('admin.expenses.update', $employees->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-2 col-md-6">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="itemName" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" value="{{ old('name', $employees->itemName) }}" placeholder="Your Name" />
                                ...
                                <div class="col-sm-2 col-md-6">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="purchaseFrom" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" value="{{ old('name', $employees->purchaseFrom) }}" placeholder=" purchaseFrom" />
                                ...
                                <div class="col-sm-2 col-md-6">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="price" class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" value="{{ old('price', $employees->price) }}" placeholder=" price" />
                                            @if ($errors->has('price'))
                                ...
                                <div class="col-sm-2 col-md-6">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="bill" class="form-control {{ $errors->has('bill') ? 'is-invalid' : '' }}" value="{{ old('bill', $employees->bill) }}" placeholder=" bill" />
                                            @if ($errors->has('bill'))
